        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "between the ###TEMPLATE### tags below. You can identify instructions for transcription between two \"{{}}\", for example: {{Summarize the transcription}} or {{List any foods mentioned}}. "
